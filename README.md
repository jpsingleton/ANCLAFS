...
Project | NuGet Install Command | .NET Core Support | ASP.NET Core Support | Website
------- | --------------------- | ----------------- | -------------------- | -------
[Dapper](https://github.com/StackExchange/dapper-dot-net) | Install-Package Dapper -Pre | [Not on RC2 yet](https://github.com/StackExchange/dapper-dot-net/issues/241) | [Not on RC2 yet](https://github.com/StackExchange/dapper-dot-net/issues/241) | [github.io](https://stackexchange.github.io/dapper-dot-net)
